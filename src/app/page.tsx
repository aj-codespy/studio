...
export default function HomePage() {
  return (
    <>
      <HeroSection />
      {/* Future sections (Portfolio, Case Studies, etc.) can be added here */}
      {/* Example placeholder for content below hero */}
      <div className="container mx-auto py-16 px-4">
        <h2 className="font-headline text-3xl font-semibold text-center mb-8">Our Services</h2>
